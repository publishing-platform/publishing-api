module DownstreamService
  ...
  # Sets the value for the Publishing-Platform-Dependency-Resolution-Source-Content-Id header.
  #
  ...
  def self.set_publishing_platform_dependency_resolution_source_content_id_header(value)
    PublishingPlatformApi::PublishingPlatformHeaders.set_header(
      :publishing_platform_dependency_resolution_source_content_id,
      value,
    )
  end
end