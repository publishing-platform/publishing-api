module Queries
  class GetExpandedLinks
    def self.call(content_id, with_drafts: true, generate: false)
      new(content_id, with_drafts, generate).call
    end
  ...
  private
    ...
    attr_reader :content_id, :with_drafts, :generate

    def initialize(content_id, with_drafts, generate)
