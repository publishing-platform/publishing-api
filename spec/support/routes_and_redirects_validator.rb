  ...
  describe "redirects validations" do
    ...
    context "when destination is external url" do
      it "is invalid if it is not actually an external url" do
        ["https://publishing-platform.co.uk/test", "https://www.publishing-platform.co.uk/foo/bar"].each do |destination|
      ...
      it "is invalid if the url is a malformed publishing-platform.co.uk external url" do
        %w[
          ://new-vat-rates.campaign.publishing-platform.co.uk/
          http:new-vat-rates.campaign.publishing-platform.co.uk/
          httpsnew-vat-rates.campaign.publishing-platform.co.uk/
          https://new_vat-rates.campaign.publishing-platform.co.uk/
          http://.campaign.publishing-platform.co.uk/
          http://new-vat-rates.campaign.publishing-platform.co.uk/path/to/your/new/vat-rates
          http://new-vat-rates.campaignjserviceppublishing-platform.co.uk/path/to/your/new/vat-rates
          https://fakesite.net/.new-vat-rates.campaign.publishing-platform.co.uk/path/to/your/new/vat-rates
          ftp://new-vat-rates.campaign.publishing-platform.co.uk/
          https://evilpublishing-platform.co.uk/
        ].each do |destination|
          edition.redirects = [{ path: "#{subject.base_path}/foo", type: "exact", destination: }]
      ...
      it "is valid if the url is a wellformed publishing-platform.co.uk external url" do
        %w[
          https://www.pointsoflight.publishing-platform.co.uk/
          https://www.cloud.service.publishing-platform.co.uk/
          https://test.campaign.publishing-platform.co.uk/
          https://test.campaign.publishing-platform.co.uk/path/to/your/new/test/campaign
          https://test.campaign.publishing-platform.co.uk/path/to/your/new/test/campaign?q=123&&a=23344
        ].each do |destination|
