class CreateLinks < ActiveRecord::Migration[7.1]
  def change
    create_table :links do |t|
      ...
      t.index %i[link_set_id target_content_id], name: "index_links_on_link_set_id_and_target_content_id"
      t.index [:link_type], name: "index_links_on_link_type"
      t.index %i[target_content_id link_type], name: "index_links_on_target_content_id_and_link_type"
